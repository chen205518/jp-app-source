...
<template>
  <div class="h-dvh bg-[#7BA05B] flex flex-col overflow-hidden">
    ...
    <div class="flex-1 flex flex-col px-3 gap-y-3 overflow-y-auto pb-[80px]">
      <div class="flex-1 bg-[#A8C686]/60 backdrop-blur-xl rounded-2xl shadow-lg p-1 border border-white/20">
      ...
      <div class="shrink-0">
        <div class="bg-[#6D5D4D]/80 backdrop-blur-xl rounded-xl shadow-lg p-2 text-center border border-white/20">
          ...
          <div class="text-xs text-[#F5F5DC] mb-2">{{ selectedChar?.romanji }}</div>
          <button
